...
$sourceConnString = "postgresql://postgres:Seattle123@localhost:5432/reg_app";
$targetConnString = "postgresql://s2admin:Seattle123Seattle123@cjg-pg-single-01:5432/postgres";

$sourceConnString = "host=localhost port=5432 dbname=reg_app user=postgres:Seattle123@localhost";
$targetConnString = "host=cjg-pg-single-01.postgres.database.azure.com port=5432 dbname=postgres user=s2admin:Seattle123Seattle123@cjg-pg-single-01";
...
$targetConnStringA = @{};
$targetConnStringA.Host = "cjg-pg-single-01.postgres.database.azure.com";
